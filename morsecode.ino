...
char senyalEntradaALletra() {  
  if (comprovaSenyalEntrada(PUNT, RAYA, PAUSA, PAUSA, PAUSA))  { return 'A'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, PUNT, PUNT, PAUSA))    { return 'B'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, RAYA, PUNT, PAUSA))   { return 'C'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, PUNT, PAUSA, PAUSA))   { return 'D'; }
  if (comprovaSenyalEntrada(PUNT, PAUSA, PAUSA, PAUSA, PAUSA))  { return 'E'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, RAYA, PUNT, PAUSA))    { return 'F'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, PUNT, PAUSA, PAUSA))  { return 'G'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, PUNT, PAUSA))     { return 'H'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PAUSA, PAUSA, PAUSA))   { return 'I'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, RAYA, RAYA, PAUSA))  { return 'I'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, RAYA, PAUSA, PAUSA))  { return 'K'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, PUNT, PUNT, PAUSA))    { return 'L'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, PAUSA, PAUSA, PAUSA)) { return 'M'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, PAUSA, PAUSA, PAUSA))  { return 'N'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, RAYA, PAUSA, PAUSA)) { return 'O'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, RAYA, PUNT, PAUSA))   { return 'P'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, PUNT, RAYA, PAUSA))  { return 'Q'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, PUNT, PAUSA, PAUSA))   { return 'R'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, PAUSA, PAUSA))    { return 'S'; }
  if (comprovaSenyalEntrada(RAYA, PAUSA, PAUSA, PAUSA, PAUSA)) { return 'T'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, RAYA, PAUSA, PAUSA))   { return 'U'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, RAYA, PAUSA))    { return 'V'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, RAYA, PAUSA, PAUSA))  { return 'W'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, PUNT, RAYA, PAUSA))   { return 'X'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, RAYA, RAYA, PAUSA))  { return 'Y'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, PUNT, PUNT, PAUSA))   { return 'Z'; }
  if (comprovaSenyalEntrada(PUNT, RAYA, RAYA, RAYA, RAYA))  { return '1'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, RAYA, RAYA, RAYA))   { return '2'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, RAYA, RAYA))    { return '3'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, PUNT, RAYA))     { return '4'; }
  if (comprovaSenyalEntrada(PUNT, PUNT, PUNT, PUNT, PUNT))      { return '5'; }
  if (comprovaSenyalEntrada(RAYA, PUNT, PUNT, PUNT, PUNT))     { return '6'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, PUNT, PUNT, PUNT))    { return '7'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, RAYA, PUNT, PUNT))   { return '8'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, RAYA, RAYA, PUNT))  { return '9'; }
  if (comprovaSenyalEntrada(RAYA, RAYA, RAYA, RAYA, RAYA)) { return '0'; }
  return '?';
}
